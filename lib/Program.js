...
(function() {
  ...
  Program = (function() {
    ...
    function Program(options) {
      ...
      this.initNcurses = __bind(this.initNcurses, this);
    ...
    Program.prototype.initCommander = function() {
      ...
      return program.version(Program.getVersion()).usage('[options] hostname/ip[:port]').option('-v, --verbose', 'verbose');
    };
    ...
    Program.prototype.parseOptions = function() {
      ...
      return console.log(this.options.args);
    };
    ...
    Program.prototype.initNcurses = function(fn) {
      if (fn == null) {
        fn = null;
      }

(function() {
  ...
  Program = (function(_super) {
    ...
    function Program(options) {
      ...
      if ((_base = this.options).name == null) _base.name = 'xbmc-remote-keyboard';
      this.initCommander();
      return this;
    }
    ...
    Program.prototype.parseOptions = function() {
      ...
      if (this.options.args[0] != null) {
        ...
        if (arg.indexOf('://') !== 0) arg = "http://" + arg;
        target = url.parse(arg);
        if (target['port'] != null) {
          this.options['port'] = parseInt(target['port']);
        }
        if (target['hostname']) this.options['host'] = target['hostname'];
        if (target['auth'] != null) {
      ...
      if (this.options.host == null) return program.help();
    };
    ...
    Program.prototype.run = function() {
      ...
      return this.initXbmc(function(err, reason) {
        ...
        if (err) return _this.close(reason);
